...
* @retval #CONNECTION_ERROR_NOT_SUPPORTED     Not Supported
*/
int connection_profile_get_prefix_length(connection_profile_h profile, unsigned char* prefix_length);
...
* @see connection_update_profile()
*/
int connection_profile_set_prefix_length(connection_profile_h profile, unsigned char prefix_length);
