 ...
 * @retval #CONNECTION_ERROR_NOT_SUPPORTED     Not Supported
*/
int connection_profile_get_cellular_pdn_type(connection_profile_h profile, connection_cellular_pdn_type_t* type);
 ...
 * @retval #CONNECTION_ERROR_NOT_SUPPORTED     Not Supported
*/
int connection_profile_get_cellular_roam_pdn_type(connection_profile_h profile, connection_cellular_pdn_type_t* type);
 ...
 * @retval #CONNECTION_ERROR_NOT_SUPPORTED     Not Supported
*/
int connection_profile_set_cellular_pdn_type(connection_profile_h profile, connection_cellular_pdn_type_t type);
 ...
 * @retval #CONNECTION_ERROR_NOT_SUPPORTED     Not Supported
*/
int connection_profile_set_cellular_roam_pdn_type(connection_profile_h profile, connection_cellular_pdn_type_t type);
